...
const READINGS = {
  en: [
    ...
    { id: "en-r6", level: "A1", title: "My Cat Milo", cover: "🐱", minutes: 2, desc: "Bir kedi ve sahibi hakkında sevimli bir hikâye.",
      paragraphs: [["I have a cat. His name is Milo.", "Bir kedim var. Adı Milo."], ["Milo is small and white.", "Milo küçük ve beyaz."], ["He likes to sleep all day.", "Bütün gün uyumayı sever."], ["In the evening, he plays with a ball.", "Akşamları bir topla oynar."], ["Milo loves fish very much.", "Milo balığı çok sever."], ["At night, he sleeps on my bed.", "Geceleri yatağımda uyur."], ["I love my cat Milo.", "Kedim Milo'yu seviyorum."]],
      vocab: [["cat", "kedi"], ["small", "küçük"], ["play", "oynamak"], ["bed", "yatak"]] },

    { id: "en-r7", level: "A1", title: "At the Market", cover: "🍎", minutes: 2, desc: "Pazarda alışveriş — basit günlük diyalog.",
      paragraphs: [["Lina goes to the market on Saturday.", "Lina cumartesi pazara gider."], ["She wants apples and bread.", "Elma ve ekmek ister."], ["“How much are the apples?” she asks.", "“Elmalar ne kadar?” diye sorar."], ["“Two dollars,” says the man.", "“İki dolar,” der adam."], ["Lina buys apples, bread, and milk.", "Lina elma, ekmek ve süt alır."], ["She says “thank you” and goes home.", "“Teşekkürler” der ve eve gider."]],
      vocab: [["market", "pazar"], ["want", "istemek"], ["buy", "satın almak"], ["how much", "ne kadar"]] },

    { id: "en-r8", level: "A2", title: "A Rainy Trip", cover: "🌧️", minutes: 3, desc: "Yağmurlu bir günde küçük bir macera.",
      paragraphs: [["Last weekend, we went to the mountains.", "Geçen hafta sonu dağlara gittik."], ["The weather was bad and it rained a lot.", "Hava kötüydü ve çok yağmur yağdı."], ["Our tent got wet, so we laughed and ran to the car.", "Çadırımız ıslandı, biz de gülüp arabaya koştuk."], ["We drove to a small village and found a warm café.", "Küçük bir köye gittik ve sıcak bir kafe bulduk."], ["We drank hot chocolate and watched the rain.", "Sıcak çikolata içtik ve yağmuru izledik."], ["It was not the trip we planned, but it was fun.", "Planladığımız gezi değildi ama eğlenceliydi."]],
      vocab: [["weekend", "hafta sonu"], ["weather", "hava durumu"], ["tent", "çadır"], ["village", "köy"]] },

    { id: "en-r9", level: "A2", title: "The New Neighbor", cover: "🏠", minutes: 3, desc: "Yeni bir komşuyla tanışma.",
      paragraphs: [["A new family moved into the house next door.", "Yan eve yeni bir aile taşındı."], ["One morning, a boy knocked on our door.", "Bir sabah bir çocuk kapımızı çaldı."], ["“Hi, I'm Sam. We just moved here,” he said.", "“Merhaba, ben Sam. Buraya yeni taşındık,” dedi."], ["My sister and I showed him the park nearby.", "Kız kardeşim ve ben ona yakındaki parkı gösterdik."], ["Soon, we became good friends.", "Kısa sürede iyi arkadaş olduk."], ["Now we play football together every weekend.", "Artık her hafta sonu birlikte futbol oynuyoruz."]],
      vocab: [["neighbor", "komşu"], ["move", "taşınmak"], ["knock", "kapı çalmak"], ["nearby", "yakındaki"]] },

    { id: "en-r10", level: "B1", title: "The Lighthouse Keeper", cover: "🗼", minutes: 5, desc: "Yalnız bir deniz feneri bekçisinin hikâyesi (2 bölüm).",
      paragraphs: [["For thirty years, Elias had kept the lighthouse on the rocky island.", "Otuz yıl boyunca Elias kayalık adadaki deniz fenerine baktı."], ["Every night, he climbed the long staircase and lit the great lamp.", "Her gece uzun merdiveni tırmanır ve büyük lambayı yakardı."], ["Ships passed in the darkness, guided safely by his light.", "Gemiler karanlıkta geçer, onun ışığıyla güvenle yön bulurdu."], ["He rarely spoke to anyone, but he never felt truly alone.", "Kimseyle pek konuşmazdı ama asla gerçekten yalnız hissetmezdi."], ["One stormy night, he saw a small boat in trouble near the rocks.", "Fırtınalı bir gece, kayaların yakınında zor durumda küçük bir tekne gördü."], ["Without hesitating, he rowed out into the wild sea.", "Tereddüt etmeden vahşi denize kürek çekti."], ["He saved two fishermen and brought them back to the warm tower.", "İki balıkçıyı kurtardı ve onları sıcak kuleye getirdi."], ["The next morning, the whole village came to thank him.", "Ertesi sabah bütün köy ona teşekkür etmeye geldi."], ["For the first time in years, Elias smiled and felt part of something.", "Yıllar sonra ilk kez Elias gülümsedi ve bir şeyin parçası hissetti."]],
      vocab: [["lighthouse", "deniz feneri"], ["staircase", "merdiven"], ["hesitate", "tereddüt etmek"], ["row", "kürek çekmek"]] },

    { id: "en-r11", level: "B2", title: "The Algorithm", cover: "💻", minutes: 6, desc: "Teknolojiyle gelen etik bir ikilem.",
      paragraphs: [["Maya was a brilliant engineer at a fast-growing tech company.", "Maya hızla büyüyen bir teknoloji şirketinde parlak bir mühendisti."], ["Her team had built an algorithm that could predict customer behavior.", "Ekibi, müşteri davranışını tahmin edebilen bir algoritma geliştirmişti."], ["At first, it seemed harmless — just better recommendations.", "İlk başta zararsız görünüyordu — yalnızca daha iyi öneriler."], ["But she soon noticed that it was quietly manipulating people's choices.", "Ama kısa süre sonra insanların seçimlerini sessizce yönlendirdiğini fark etti."], ["Her manager insisted that profits had never been higher.", "Müdürü kârın hiç bu kadar yüksek olmadığında ısrar etti."], ["Maya faced a difficult decision: stay silent or speak out.", "Maya zor bir kararla karşı karşıyaydı: sessiz kalmak ya da konuşmak."], ["She knew that doing the right thing might cost her the job.", "Doğru olanı yapmanın ona işine mal olabileceğini biliyordu."], ["Nevertheless, she wrote a detailed report and sent it to the board.", "Yine de ayrıntılı bir rapor yazıp yönetim kuruluna gönderdi."], ["Change, she believed, always begins with one honest voice.", "Değişimin her zaman dürüst bir sesle başladığına inanıyordu."]],
      vocab: [["brilliant", "parlak/zeki"], ["predict", "tahmin etmek"], ["manipulate", "yönlendirmek/manipüle etmek"], ["board", "yönetim kurulu"]] },

    { id: "en-r12", level: "C1", title: "The Cartographer's Map", cover: "🗺️", minutes: 7, desc: "Gerçeği ve hayal gücünü sorgulayan edebî bir öykü.",
      paragraphs: [["The old cartographer claimed his maps showed not what was, but what could be.", "Yaşlı haritacı, haritalarının olanı değil, olabilecek olanı gösterdiğini iddia ederdi."], ["Scholars dismissed him as a charlatan, yet travelers swore by his work.", "Bilginler onu bir şarlatan olarak görmezden geldi, yine de gezginler işine güvendiler."], ["Each map was, in essence, an argument about the nature of reality.", "Her harita, özünde gerçekliğin doğası hakkında bir argümandı."], ["Where others drew coastlines, he drew possibilities and quiet warnings.", "Başkalarının kıyı çizgileri çizdiği yere o, olasılıklar ve sessiz uyarılar çizerdi."], ["“A map that merely copies the world,” he would say, “is a mirror, not a guide.”", "“Dünyayı sadece kopyalayan bir harita,” derdi, “bir rehber değil, bir aynadır.”"], ["His final map was left unfinished, with a single blank region at its heart.", "Son haritası, tam ortasında tek bir boş bölgeyle yarım bırakıldı."], ["Some say it was a failure; others, that it was his most honest work.", "Kimi bunun bir başarısızlık olduğunu söyler; kimi ise en dürüst eseri olduğunu."], ["For what is the unknown, after all, but the space where imagination begins?", "Sonuçta bilinmeyen, hayal gücünün başladığı boşluktan başka nedir ki?"]],
      vocab: [["cartographer", "haritacı"], ["dismiss", "görmezden gelmek/reddetmek"], ["in essence", "özünde"], ["unfinished", "yarım/bitmemiş"]] },
  ],
  es: [
